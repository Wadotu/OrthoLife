...
public class BookNameMapper {
    ...
    static {
        ...
        map.put("1Co", "I 고린토");
        map.put("1 Corinthians", "I 고린토");
        map.put("I Corinthians", "I 고린토");
        
        map.put("2Co", "II 고린토");
        map.put("2 Corinthians", "II 고린토");
        map.put("II Corinthians", "II 고린토");

        map.put("Gal", "갈라디아");
        map.put("Galatians", "갈라디아");
        
        map.put("Eph", "에페소");
        map.put("Ephesians", "에페소");
        
        map.put("Phi", "필립비");
        map.put("Philippians", "필립비");
        
        map.put("Col", "골로사이");
        map.put("Colossians", "골로사이");

        map.put("1Th", "I 데살로니카");
        map.put("1 Thessalonians", "I 데살로니카");
        
        map.put("2Th", "II 데살로니카");
        map.put("2 Thessalonians", "II 데살로니카");

        map.put("1Ti", "I 디모테오");
        map.put("1 Timothy", "I 디모테오");
        
        map.put("2Ti", "II 디모테오");
        map.put("2 Timothy", "II 디모테오");

        map.put("Tit", "디도");
        map.put("Titus", "디도");
        
        map.put("Phm", "필레몬");
        map.put("Philemon", "필레몬");
        ...
        map.put("1Pe", "I 베드로");
        map.put("1 Peter", "I 베드로");
        
        map.put("2Pe", "II 베드로");
        map.put("2 Peter", "II 베드로");

        map.put("1Jo", "I 요한");
        map.put("1 John", "I 요한");
        
        map.put("2Jo", "II 요한");
        map.put("2 John", "II 요한");
        
        map.put("3Jo", "III 요한");
        map.put("3 John", "III 요한");

        map.put("Jud", "유다");
        map.put("Jude", "유다");
        
        map.put("Rev", "요한 묵시록");
        map.put("Revelation", "요한 묵시록");
